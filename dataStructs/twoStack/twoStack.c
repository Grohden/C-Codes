...
DualStack * initDualStack(int stackSize)
{
	...
	//N�o h� nada em nenhum dos das duas pilhas
	s->sizeInfo = 0;

	//Deve come�ar em -1
	s->topOne = -1;
	//Deve come�ar no maxCapacity valor normal
	s->topTwo = s->maxCapacity;

	//Aloca o espa�o para o array onde as stacks duplas estar�o
...
bool isSecondStackEmpty(DualStack * dualStack) {
	//Se o topo da pilha maior � igual ao topo da segunda pilha filha
